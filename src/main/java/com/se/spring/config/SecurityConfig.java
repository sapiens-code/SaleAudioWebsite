...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.inMemoryAuthentication().withUser("lamminhhy9999@gmail.com").password("1234").authorities("ROLE_ADMIN");
		auth.inMemoryAuthentication().withUser("user@gmail.com").password("1234").authorities("ROLE_USER");
