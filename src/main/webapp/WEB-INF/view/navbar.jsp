...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<c:url value="/resource/images/headphones.png"/>"/>
...
<nav class="navbar navbar-inverse">
    <div  class="container-fluid">
        <div class="navbar">
            <img src="<c:url value="/resource/images/headphones.png"/>" width="210px" height="130px" alt="logo-image"/>
        </div>
